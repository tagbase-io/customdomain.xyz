...
import TwinValleyCarousel from "@/components/TwinValleyCarousel";
import TwinValleyDetails from "@/components/TwinValleyDetails";
import VerificationStatus from "@/components/VerificationStatus";
import { useVerification } from "@/hooks/useVerification";
import { Alert, AlertDescription } from "@/components/ui/alert";
import { Info } from "lucide-react";

const TwinValleyReserve = () => {
      ...
      <main className="pt-6 pb-16">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            {/* Product Details */}
            <TwinValleyDetails status={status} productData={productData} />
          </div>
        </div>
      </main>
...
export default TwinValleyReserve;
