...
import McfShirtCarousel from "@/components/McfShirtCarousel";
...
const McfShirt2526 = () => {
  ...
  useEffect(() => {
    document.title = "TAGBASE | Official Málaga CF Home Shirt 2025/26";
    const descriptionText =
      "Official Málaga CF 1st Kit 2025/26 by hummel. Sky blue and white vertical stripes with NFC-verified authenticity.";
  ...
  return (
    <div className="min-h-screen text-white font-body" style={{ background: MCF_DARK }}>
      {/* Tagbase Banner */}
      <div className="text-center py-2.5 px-4" style={{ background: MCF_BLUE }}>
      ...
      <main className="pb-12">
        <div className="max-w-lg mx-auto px-4">
            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                <h1 className="text-2xl font-bold tracking-tight uppercase font-body">
                  Official Malaga CF Home Shirt 2025/26
                </h1>
              ...
              >
                ...
                <AccordionContent className="px-4 pb-4 pt-0">
                  <p className="text-sm text-gray-300 leading-relaxed">
                    The official Málaga CF home shirt for the 2025/26 season, manufactured by hummel. 
                    Featuring the club's iconic sky blue and white vertical stripes, this jersey 
                    combines tradition with modern performance. The lightweight, breathable fabric 
                    ensures maximum comfort both on the pitch and in the stands. Adorned with the 
                    official Málaga CF crest, hummel chevron detailing on the sleeves, and sponsor 
                    logos. The "Colores Blanquiazules" tagline is printed inside the collar as a 
                    tribute to the fans. Available in sizes XS to XXXL. Material: 100% Recycled 
                    Polyester. Color: Sky Blue / White / Royal Blue.
                  </p>
                </AccordionContent>
              </AccordionItem>
                ...
                <AccordionContent className="px-4 pb-4 pt-0">
                  <div className="space-y-2">
                    {[
                      ...
                      { name: "Care Instructions", type: "PDF", size: "95 KB" },
          ...
          >
            ...
            {/* Shop link */}
            <a
              href="https://www.tiendamalagacf.com/es/equipaciones/458-1252-camiseta-oficial-1-equipacion-malaga-cf-202526.html"
              target="_blank"
              rel="noopener noreferrer"
