...
import purse1 from "@/assets/purse-1.webp";
import purse2 from "@/assets/purse-2.webp";
import purse3 from "@/assets/purse-3.webp";
      ...
      <div className="relative aspect-[4/3] overflow-hidden rounded-sm bg-cream-dark">
        <AnimatePresence initial={false} custom={direction}>
          <motion.img
            ...
            alt={`Leopard Luxe City Bag - View ${currentIndex + 1}`}
            custom={direction}
