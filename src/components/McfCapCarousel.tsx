...
import cap1 from "@/assets/mcf-cap-1.jpg";
import cap2 from "@/assets/mcf-cap-2.jpg";
import cap3 from "@/assets/mcf-cap-3.jpg";

const images = [cap1, cap2, cap3];

const McfCapCarousel = () => {
      ...
      <div className="relative aspect-square overflow-hidden rounded-2xl bg-gradient-to-b from-gray-100 to-gray-200">
        <AnimatePresence initial={false} custom={direction}>
          <motion.img
            ...
            alt={`MCF Black Fan Cap - View ${currentIndex + 1}`}
            custom={direction}
