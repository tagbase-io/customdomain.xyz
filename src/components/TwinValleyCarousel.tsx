...
import wine1 from "@/assets/wine-1.png";
import wine2 from "@/assets/wine-2.png";
import wine3 from "@/assets/wine-3.png";

const images = [wine1, wine2, wine3];

const TwinValleyCarousel = () => {
      ...
      <div className="relative aspect-[4/3] overflow-hidden rounded-sm bg-cream-dark">
        <AnimatePresence initial={false} custom={direction}>
          <motion.img
            ...
            alt={`Twin Valley Reserve - View ${currentIndex + 1}`}
            custom={direction}
...
export default TwinValleyCarousel;
